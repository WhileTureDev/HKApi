...
async def create_release(
    ...
    try:
        ...
        try:
            # Create a new ChangeLog entry using the model
            ...
            logger.error(f"Failed to log change for release {release_name}: {e}")
            # Don't raise the exception since the deployment was successful
